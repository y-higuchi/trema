...
test_switch_status_event_then_flow_mod_lldp_if_sw_up() {
  ...
  expect_value( helper_sw_received_flow_mod_add_lldp_message_end,
...
test_switch_status_event_over_ip_then_flow_mod_lldp_if_sw_up() {
  ...
  expect_value( helper_sw_received_flow_mod_add_lldp_over_ip_message_end,
                tag, MESSENGER_OPENFLOW_MESSAGE );
  expect_value( helper_sw_received_flow_mod_add_lldp_over_ip_message_end,
                datapath_id, 0x1234 );
  expect_value( helper_sw_received_flow_mod_add_lldp_over_ip_message_end,
...
test_disable_discovery_when_sw_exist_then_flow_mod_del_lldp() {
  ...
  expect_value( helper_sw_received_flow_mod_del_lldp_message_end,
                tag, MESSENGER_OPENFLOW_MESSAGE );
  expect_value( helper_sw_received_flow_mod_del_lldp_message_end,
                datapath_id, 0x1234 );
...
test_disable_discovery_when_sw_exist_then_flow_mod_del_lldp_over_ip() {
  ...
  expect_value( helper_sw_received_flow_mod_del_lldp_over_ip_message_end,
                tag, MESSENGER_OPENFLOW_MESSAGE );
  expect_value( helper_sw_received_flow_mod_del_lldp_over_ip_message_end,
                datapath_id, 0x1234 );
  expect_value( helper_sw_received_flow_mod_del_lldp_over_ip_message_end,

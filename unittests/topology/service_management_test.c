...
//  assert_true( add_message_received_callback( TEST_CONTROL_NAME, callback_test_control_notification_handler ) );
  ...
  topology_request *req = append_back_buffer( buf, req_len );
  strcpy( req->name, TEST_SUBSCRIBER_NAME );
  send_request_message( TEST_TREMA_NAME, TEST_SUBSCRIBER_NAME, TD_MSGTYPE_QUERY_SWITCH_STATUS_REQUEST,
                        buf->data, buf->length, NULL );
  free_buffer( buf );
...
//  assert_true( add_message_received_callback( TEST_CONTROL_NAME, callback_test_control_notification_handler ) );
  ...
  topology_request *req = append_back_buffer( buf, req_len );
  strcpy( req->name, TEST_SUBSCRIBER_NAME );
  send_request_message( TEST_TREMA_NAME, TEST_SUBSCRIBER_NAME, TD_MSGTYPE_QUERY_PORT_STATUS_REQUEST,
                        buf->data, buf->length, NULL );
  free_buffer( buf );
...
//  assert_true( add_message_received_callback( TEST_CONTROL_NAME, callback_test_control_notification_handler ) );
  ...
  dpid = 0x5678;
  update_link_to( port, &dpid, 72, true );
  ...
  topology_request *req = append_back_buffer( buf, req_len );
  strcpy( req->name, TEST_SUBSCRIBER_NAME );
  send_request_message( TEST_TREMA_NAME, TEST_SUBSCRIBER_NAME, TD_MSGTYPE_QUERY_LINK_STATUS_REQUEST,
                        buf->data, buf->length, NULL );
  free_buffer( buf );


  expect_value( mock_query_link_status_reply, number_of_links, 2 );
